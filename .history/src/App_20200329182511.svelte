<script>
  ...
  $: notifVisible = $alertVisible;
  $: notifMessage = $alertMessage;
  $: notifTitle = $alertTitle;
</script>
...
<style>
  ...
  div {
    ...
    box-shadow: 19px 19px 39px #cccccc, -19px -19px 39px #ffffff;
    width: 100%;
    height: 100%;
  }
</style>
...
<Notification
  bind:visible={notifVisible}
  bind:title={notifTitle}
  bind:message={notifMessage} />
<section>
  <div>
