...
<div class="p-2">
  ...
  <hr />
  <h2
    class="flex content-center justify-between p-3 text-xl text-left text-gray-600 uppercase">
    <span>
      {studentName}
      <span class="text-xl text-gray-600 capitalize">{studentPrenom}</span>
    </span>
    <span class="p-4 text-2xl align-middle">{selectedStudent.moyenne}</span>
  </h2>
</div>
